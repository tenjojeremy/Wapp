...
const Countdown = ({
  ...
  const handleTimeLeft = () => {
    ...
    const ended = timeLeft.days === '00' && timeLeft.hours === '00' && timeLeft.minutes === '00' && timeLeft.seconds === '00';
  ...
  const getTimerComponents = () => {
    ...
    timeLeftKeys.forEach((interval, index) => {
      ...
      const mergedTypographyStyles = { ...styles.typographyStyles,
        ...typographyStyles
      };
      newTimerComponents.push( /*#__PURE__*/React.createElement(Fragment, {
        key: key
      }, /*#__PURE__*/React.createElement(Typography, {
        styles: mergedTypographyStyles,
        text: "".concat(timeLeftInterval, " ").concat(name)
      }), /*#__PURE__*/React.createElement(Typography, {
        styles: mergedTypographyStyles,
        text: "".concat(separatorString)
      })));
    });
